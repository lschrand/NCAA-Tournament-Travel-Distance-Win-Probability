...
acc1=float(cv1.mean()*100); acc2=float(cv2.mean()*100); acc3=float(cv3.mean()*100)
acc4=float(cv4.mean()*100); acc5=float(cv5.mean()*100)
...
with m_models:
    ...
    sds=[float(cv1.std()),float(cv2.std()),float(cv3.std()),float(cv4.std()),float(cv5.std())];bcs=[MUTED,ORANGE,CYAN,GREEN,PURPLE]
