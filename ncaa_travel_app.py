...
/* ── Mobile responsive fixes (only activates on screens < 768px) ── */
@media (max-width: 768px) {
    ...
    div[data-testid="stMetric"] { padding: 8px 12px !important; min-width: 45% !important; flex: 1 1 45% !important; }
    /* Make tabs scrollable instead of squished */
    .stTabs [data-baseweb="tab-list"] {
        overflow-x: auto !important; flex-wrap: nowrap !important;
        -webkit-overflow-scrolling: touch; padding: 4px !important;
    }
    .stTabs [data-baseweb="tab"] {
        padding: 8px 12px !important; font-size: 0.8rem !important;
        white-space: nowrap !important; flex-shrink: 0 !important;
    }
    /* Smaller guide/info boxes */
    .chart-guide, .how-to-read, .landing-card { padding: 10px 12px !important; margin: 6px 0 10px 0 !important; }
    .chart-guide p, .how-to-read p, .landing-card p { font-size: 0.8rem !important; }
    .nav-card { min-height: auto !important; padding: 12px !important; }
    .nav-card p { font-size: 0.75rem !important; }
    /* Make plotly charts horizontally scrollable */
    div[data-testid="stPlotlyChart"] { overflow-x: auto !important; -webkit-overflow-scrolling: touch; }
    /* Sidebar adjustments */
    section[data-testid="stSidebar"] { min-width: 250px !important; }
    /* Photo sizing */
    [data-testid="stImage"] img { width: 80px !important; height: 80px !important; }
}
/* Extra small screens (phones in portrait) */
@media (max-width: 480px) {
    h1 { font-size: 1.3rem !important; }
    div[data-testid="stMetric"] { min-width: 100% !important; flex: 1 1 100% !important; }
